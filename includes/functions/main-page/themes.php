...
$template_locations = Config::get_template_location( 'main-page' );
					...
					<div class="wpui-details">
						...
						<?php
							if ( $is_active === 'active-template' ) {
								...
								echo '<a href="" class="wpui-template-activator" data-theme-name="gallery-main-page" data-theme-value="' . $template_fullname . '">Activate</a>';
							}
						?>
					</div>
				</div>
