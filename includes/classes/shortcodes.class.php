...
if ( !class_exists( 'aios_filterable_shortcode' ) ) {

    class aios_filterable_shortcode
    {
         ...
         * @return string
         */
        public function get_aios_filterable_shortcode_gallery($atts)
        {
    ...
    $aios_filterable_shortcode = new aios_filterable_shortcode();
