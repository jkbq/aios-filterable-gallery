	...
	class aios_filterable_gallery_enqueue {
		...
		public function admin_ui() {
			...
			wp_enqueue_script( 'aios-filterable-script', AIOS_FILTERABLE_URL_ASSETS_JS .'admin-scripts.js' );
			 ...
			 global $post_type;
			 if( 'cases' == $post_type ){
        			wp_enqueue_style( 'aios-post-type', AIOS_FILTERABLE_URL_ASSETS_CSS .'post-type.css' );
            }
		...
		public function frontend_uiux() {
            ...
            wp_localize_script( 'aios-filterable-gallery', 'ajaxurl', admin_url( 'admin-ajax.php' ) );
